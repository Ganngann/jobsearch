    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center gap-3">
            ...
            >
                ...
                <div class="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-64 p-3 bg-slate-900 text-white text-[10px] font-bold rounded-xl opacity-0 group-hover:opacity-100 group-focus:opacity-100 focus-within:opacity-100 group-focus-within:opacity-100 transition-all pointer-events-none z-[100] text-left shadow-2xl border border-white/10">
