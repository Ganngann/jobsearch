        ...
        <div class="flex items-start justify-between gap-6">
            ...
            <div class="flex flex-col items-end gap-4">
                    ...
                    <div class="relative group cursor-help">
                        ...
                        <div class="absolute right-full top-0 mr-6 w-80 p-6 bg-slate-900 text-white rounded-[2.5rem] shadow-[0_35px_60px_-15px_rgba(0,0,0,0.6)] opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 focus-within:opacity-100 pointer-events-none transition-all duration-500 z-[100] transform translate-x-4 group-hover:translate-x-0">
                    ...
                    <div class="space-y-3">
                        ...
                        @foreach($jobOffer->skills as $skill)
                            ...
                            <div x-data="{ 
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="text-[9px] font-black uppercase tracking-widest opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 focus-within:opacity-100 transition-opacity" :class="{
                                    ...
                                    <div class="flex items-center gap-1 bg-white/50 p-1 rounded-xl border border-slate-100 transition-opacity duration-300" 
                                         :class="status !== 'none' ? 'opacity-100' : 'opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 focus-within:opacity-100'">
