                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="flex items-center gap-1 bg-white/50 p-1 rounded-xl border border-slate-100 transition-opacity duration-300" 
                                        ...
                                        <button @click.stop="updateStatus('active')" 
                                                ...
                                                :title="status === 'active' ? 'Compétence validée (cliquer pour annuler)' : 'Valider cette compétence'"
                                                :aria-label="status === 'active' ? 'Compétence validée (cliquer pour annuler)' : 'Valider cette compétence'"
                                        ...
                                        <button @click.stop="updateStatus('refused')" 
                                                ...
                                                :title="status === 'refused' ? 'Compétence écartée (cliquer pour annuler)' : 'Refuser/Écarter cette compétence'"
                                                :aria-label="status === 'refused' ? 'Compétence écartée (cliquer pour annuler)' : 'Refuser/Écarter cette compétence'"
