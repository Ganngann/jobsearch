                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="flex items-center gap-1 bg-white/50 p-1 rounded-xl border border-slate-100 transition-opacity duration-300" 
                                        ...
                                        <button @click.stop="updateStatus('active')" 
                                                class="p-1 rounded-lg transition-all focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-emerald-500"
                                        ...
                                        <button @click.stop="updateStatus('refused')" 
                                                class="p-1 rounded-lg transition-all focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-rose-500"
