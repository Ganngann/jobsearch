@foreach($jobOffers as $offer)
    ...
    <div 
        ...
        @keydown.enter="selectOffer('{{ $offer->forem_id }}')"
        ...
        class="p-5 rounded-2xl border cursor-pointer transition-all duration-300 shadow-sm hover:shadow-md group relative overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:border-indigo-500 {{ $isOfferBlacklisted ? 'opacity-50 grayscale-[0.5]' : '' }}"
    >
        <!-- Score Section -->
