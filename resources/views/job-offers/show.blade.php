                                            ...
                                            <div class="flex items-center gap-1">
                                                ...
                                                @else
                                                    <button 
                                                        ...
                                                        class="p-1.5 text-slate-400 hover:text-rose-500 hover:bg-rose-50 rounded-xl transition-all focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
                                                ...
                                                <button 
                                                    ...
                                                    class="p-1.5 text-slate-400 hover:text-rose-500 hover:bg-rose-50 rounded-xl transition-all flex items-center gap-2 group focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
