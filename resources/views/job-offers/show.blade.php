                                            ...
                                            <div class="flex items-center gap-1">
                                                ...
                                                @else
                                                    <button 
                                                        ...
                                                        class="p-1.5 text-slate-400 hover:text-rose-500 hover:bg-rose-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500 rounded-xl transition-all"
                                                        title="Ajouter aux métiers favoris"
                                                        aria-label="Ajouter aux métiers favoris"
                                                    >
                                                        <svg aria-hidden="true" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg>
                                                    </button>
                                                @endif

                                                <button 
                                                    @click="refuseMetier({{ $jobOffer->metier->id }})"
                                                    class="p-1.5 text-slate-400 hover:text-rose-500 hover:bg-rose-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500 rounded-xl transition-all flex items-center gap-2 group"
                                                    title="Écarter ce métier"
                                                    aria-label="Écarter ce métier"
                                                >
                                                    <svg aria-hidden="true" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"></path></svg>
