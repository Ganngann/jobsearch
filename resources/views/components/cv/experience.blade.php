<div class="flex items-center justify-between group">
    ...
    <button @click="startCreating('experience')" class="opacity-0 group-hover:opacity-100 focus-within:opacity-100 focus:opacity-100 transition-opacity text-indigo-600 hover:text-indigo-800 mb-2" aria-label="Ajouter">
                    ...
                    <div @dblclick="startEditing('experience', exp)" class="cursor-pointer group relative">
                        <div class="flex items-start justify-between">
                            ...
                            <div class="flex items-center gap-2 ml-4">
                                ...
                                <button @click.stop="deleteItem('experience', exp.id)" class="opacity-0 group-hover:opacity-100 focus-within:opacity-100 focus:opacity-100 transition-opacity text-red-300 hover:text-red-500" aria-label="Supprimer">
