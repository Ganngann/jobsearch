<div class="flex items-center justify-between group">
    ...
    <button @click="startCreating('education')" class="opacity-0 group-hover:opacity-100 focus-within:opacity-100 focus:opacity-100 transition-opacity text-indigo-600 hover:text-indigo-800 mb-2" aria-label="Ajouter une formation" title="Ajouter une formation">
                    ...
                    <div @dblclick="startEditing('education', edu)" class="cursor-pointer group relative">
                        <div class="flex justify-between items-baseline">
                            <div class="flex-1">
                                ...
                                <button @click.stop="deleteItem('education', edu.id)" class="opacity-0 group-hover:opacity-100 focus-within:opacity-100 focus:opacity-100 transition-opacity text-red-400 hover:text-red-600" aria-label="Supprimer la formation" title="Supprimer la formation">
