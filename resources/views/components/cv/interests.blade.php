<div class="mt-6">
    <div class="flex items-center justify-between group mb-2">
        ...
        <button @click="startCreating('interest')" aria-label="Ajouter un centre d'intérêt" title="Ajouter un centre d'intérêt" class="opacity-0 group-hover:opacity-100 focus-within:opacity-100 focus:opacity-100 transition-opacity text-indigo-600 hover:text-indigo-800">
