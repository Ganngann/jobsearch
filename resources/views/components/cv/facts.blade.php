<div class="flex items-center justify-between group">
    ...
    <button @click="startCreating('fact')"
            aria-label="Ajouter un point fort"
            title="Ajouter un point fort"
            class="opacity-0 group-hover:opacity-100 focus-within:opacity-100 focus:opacity-100 transition-opacity text-indigo-600 hover:text-indigo-800 mb-2 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none focus:opacity-100">
                ...
                <div @dblclick="startEditing('fact', fact)" class="flex gap-2 items-start cursor-pointer relative group">
                    ...
                    <div class="flex-1">
                        ...
                        <button x-show="!fact.proposed_action" @click.stop="deleteItem('fact', fact.id)" 
                                ...
                                class="inline-flex items-center ml-2 p-0.5 opacity-0 group-hover:opacity-100 focus-within:opacity-100 focus:opacity-100 transition-opacity text-red-400 hover:text-red-600 align-middle focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none">
