<div class="flex items-center justify-between group">
    ...
    <button @click="startCreating('fact')" class="opacity-0 group-hover:opacity-100 focus-within:opacity-100 focus:opacity-100 transition-opacity text-indigo-600 hover:text-indigo-800 mb-2" aria-label="Ajouter un point fort">
