<div class="flex items-center gap-2 mt-2 mb-2 group">
    ...
    <button @click="startCreating('skill')" class="opacity-0 group-hover:opacity-100 focus-within:opacity-100 focus:opacity-100 transition-opacity text-indigo-600 hover:text-indigo-800" aria-label="Ajouter une compétence">
