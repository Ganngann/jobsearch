<div class="mt-4 group/lang">
    <div class="flex items-center justify-between mb-2">
        ...
        <button @click="startCreating('language')" class="opacity-0 group-hover/lang:opacity-100 focus-within:opacity-100 focus:opacity-100 transition-opacity text-indigo-600 hover:text-indigo-800" title="Ajouter une langue" aria-label="Ajouter une langue">
            ...
            <div class="relative">
                ...
                <template x-if="editingItem.id !== lang.id || editingItem.type !== 'language'">
                    <div @dblclick="startEditing('language', lang)" class="flex items-center gap-2 cursor-pointer hover:bg-indigo-50 px-2 py-1 rounded transition-colors group">
                        ...
                        <button @click.stop="deleteItem('language', lang.id)" class="opacity-0 group-hover:opacity-100 focus-within:opacity-100 focus:opacity-100 text-red-300 hover:text-red-500 ml-1" title="Supprimer la langue" aria-label="Supprimer la langue">
