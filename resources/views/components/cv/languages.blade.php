<div class="mt-4 group/lang">
    <div class="flex items-center justify-between mb-2">
        ...
        <button @click="startCreating('language')"
                aria-label="Ajouter une langue"
                title="Ajouter une langue"
                class="opacity-0 group-hover/lang:opacity-100 transition-opacity text-indigo-600 hover:text-indigo-800 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none focus:opacity-100">
            ...
            <div class="relative">
                ...
                <template x-if="editingItem.id !== lang.id || editingItem.type !== 'language'">
                    <div @dblclick="startEditing('language', lang)" class="flex items-center gap-2 cursor-pointer hover:bg-indigo-50 px-2 py-1 rounded transition-colors group">
                        ...
                        <button @click.stop="deleteItem('language', lang.id)"
                                aria-label="Supprimer la langue"
                                title="Supprimer la langue"
                                class="opacity-0 group-hover:opacity-100 focus-within:opacity-100 focus:opacity-100 text-red-300 hover:text-red-500 ml-1 focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none">
