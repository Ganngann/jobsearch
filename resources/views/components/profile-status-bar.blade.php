...
>
    ...
    <a href="{{ route('profile.builder') }}" class="flex items-center gap-3 group/nav hover:bg-white/50 px-2 py-1 rounded-xl transition-all">
        ...
        <div class="flex items-center gap-2 group relative">
            ...
            <div class="absolute top-full left-1/2 -translate-x-1/2 mt-3 w-72 bg-white border border-gray-100 rounded-2xl shadow-2xl p-5 z-[100] invisible group-hover:visible group-focus-within:visible opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-all transform translate-y-1 group-hover:translate-y-0 group-focus-within:translate-y-0">
    ...
    <a href="{{ route('profile.mobility.index') }}" class="flex items-center gap-3 group/nav hover:bg-white/50 px-2 py-1 rounded-xl transition-all">
        <span class="text-[10px] font-bold text-gray-400 uppercase tracking-widest group-hover/nav:text-blue-600 transition-colors">Mobilité et contrats</span>
        <div class="flex items-center gap-2 group relative">
