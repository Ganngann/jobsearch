<x-guest-layout>
    <div class="max-w-2xl mx-auto py-8">
        ...
        <div class="space-y-6" x-data="{ 
            ...
            <!-- Choice 1: AI Builder -->
            <a href="{{ route('profile.builder') }}" 
               class="group block p-6 bg-white/5 border border-white/10 rounded-[2rem] hover:border-indigo-500/50 hover:bg-indigo-500/5 transition-all duration-300"
               x-show="!uploading">
            ...
            <!-- Error Message -->
            <div x-show="error" x-transition class="p-5 bg-rose-500/10 border border-rose-500/20 rounded-3xl mb-4">
                <div class="flex gap-3">
                    <svg class="w-6 h-6 text-rose-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                    </svg>
                    <p class="text-rose-400 font-medium" x-text="error"></p>
                </div>
            </div>

            <!-- Choice 2: CV Import -->
            <div class="m-0">
                <label class="block cursor-pointer group p-6 bg-white/5 border border-white/10 rounded-[2rem] hover:border-violet-500/50 hover:bg-violet-500/5 transition-all duration-300">
