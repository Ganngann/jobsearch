<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            {{ __('Informations d\'Identité') }}
        </h2>

        <p class="mt-1 text-sm text-gray-600">
            {{ __("Mettez à jour vos informations de contact et votre titre professionnel.") }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" 
          x-data='{
            ...
            headline: @js($user->headline), // Security: Enforce proper JS escaping
