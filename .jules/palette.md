...
## 2026-07-04 - Dynamic ARIA Attributes
**Learning:** Stateful toggle buttons managed by Alpine.js require dynamic ARIA attributes (like :aria-pressed or dynamic :aria-label) and boolean states must be cast to string (.toString()) to avoid being removed from the DOM when false.
**Action:** Use Alpine to dynamically bind :aria-pressed and :aria-label for toggle buttons.
