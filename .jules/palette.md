...
**Learning:** Hidden interactive elements within groups require group-focus-within, aria-label, and focus-visible states to be accessible via keyboard.
**Action:** Add these attributes and classes to all newly discovered invisible hover-reveal icon actions.
