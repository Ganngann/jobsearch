...
## 2024-06-25 - Keyboard Accessibility on Hover-revealed Elements
**Learning:** Elements using group-hover:opacity-100 must include focus-within and group-focus-within states for keyboard accessibility, and icon-only buttons need aria-labels and aria-hidden svgs.
**Action:** Added focus-within:opacity-100, group-focus-within:opacity-100, focus-visible rings, and aria attributes.
