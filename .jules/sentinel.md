...
## 2026-07-19 - Enforce POST for state-changing routes
**Vulnerability:** State-changing routes allowing GET bypass CSRF protection.
**Learning:** The /vector-sync route allowed GET requests, exposing the vector-sync action to CSRF.
**Prevention:** Strictly use POST, PUT, PATCH, or DELETE methods for state-changing operations.
