...
## 2024-05-24 - CSRF Bypass on Vector Sync
**Vulnerability:** /vector-sync route allowed GET requests for state changes.
**Learning:** Route::match bypasses CSRF middleware for GET requests.
**Prevention:** Strictly use POST/PUT/PATCH/DELETE for state-changing routes.
