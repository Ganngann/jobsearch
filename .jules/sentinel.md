...
## 2026-07-17 - Fix CSRF Bypass on Vector Sync Route
**Vulnerability:** State-changing route /vector-sync allowed GET requests.
**Learning:** Allowing GET requests for state-changing operations bypasses Laravel's VerifyCsrfToken middleware.
**Prevention:** State-changing routes must strictly use POST, PUT, PATCH, or DELETE methods.
