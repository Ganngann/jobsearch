    ...
    public function dashboard(Request $request)
    {
        ...
        */
        ...
        $topMetiers = Cache::remember('dashboard.top_metiers', 3600, function() {
            // ⚡ Bolt: Use targeted select to reduce memory footprint, placed before withCount to preserve the subquery
            // 📊 Impact: Significantly reduces memory usage by preventing instantiation of unused columns (e.g., logo_base64 on Employer)
