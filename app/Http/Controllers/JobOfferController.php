...
class JobOfferController extends Controller
{
    ...
    public function dashboard(Request $request)
    {
        ...
        */
        ...
        // ⚡ Bolt: Targeted select to prevent memory bloat from large text fields like logo_base64
        // 📊 Impact: Significantly reduced memory payload when caching top employers and metiers
