    ...
    public function dashboard(Request $request)
    {
        ...
        */
        ...
        $topMetiers = Cache::remember('dashboard.top_metiers', 3600, function() {
            // ⚡ Bolt: Targeted select to prevent caching unnecessary fields
            // 📊 Impact: Reduces memory usage and cache size
        ...
        $topEmployers = Cache::remember('dashboard.top_employers', 3600, function() {
            // ⚡ Bolt: Targeted select to prevent memory bloat from massive logo_base64 fields
