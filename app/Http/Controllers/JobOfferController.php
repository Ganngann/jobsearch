    ...
    public function dashboard(Request $request)
    {
        ...
        */
        ...
        $topMetiers = Cache::remember('dashboard.top_metiers', 3600, function() {
            // ⚡ Bolt: Targeted select before withCount to avoid fetching unused fields.
            // 📊 Impact: Reduces memory footprint by explicitly selecting only necessary fields.
        ...
        $topEmployers = Cache::remember('dashboard.top_employers', 3600, function() {
            // ⚡ Bolt: Targeted select before withCount to avoid fetching unused fields.
            // 📊 Impact: Prevents severe memory bloat by excluding large fields like Employer's logo_base64.
