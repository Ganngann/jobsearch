    ...
    public function dashboard(Request $request)
    {
        ...
        */
        ...
        $topMetiers = Cache::remember('dashboard.top_metiers', 3600, function() {
            // ⚡ Bolt: Targeted select before withCount to prevent memory bloat
            // 📊 Impact: Significantly reduces memory payload for cached dashboard filter data
        ...
        $topEmployers = Cache::remember('dashboard.top_employers', 3600, function() {
            // ⚡ Bolt: Targeted select before withCount to prevent memory bloat, bypassing large logo_base64
            // 📊 Impact: Significantly reduces memory payload for cached dashboard filter data
