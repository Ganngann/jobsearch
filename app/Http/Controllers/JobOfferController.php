    ...
    public function dashboard(Request $request)
    {
        ...
        */
        ...
        $topMetiers = Cache::remember('dashboard.top_metiers', 3600, function() {
            // ⚡ Bolt: Use targeted select before aggregate to avoid large memory payload
            // 📊 Impact: Substantially reduces cache size and memory usage during serialization
        ...
        $topEmployers = Cache::remember('dashboard.top_employers', 3600, function() {
            // ⚡ Bolt: Use targeted select before aggregate to avoid loading massive logo_base64 column
            // 📊 Impact: Drastically reduces memory usage and cache payload size
